...
export default function Header({}: Props) {
  ...
  return (
    <header className='sticky top-0 z-50 flex flex-wrap gap-3 grid-cols-2 md:grid md:grid-cols-3 bg-white shadow-md p-5 md:px-10'>
      <Head>
      ...
      <div className='relative flex items-center cursor-pointer my-auto' onClick={() => router.push("/")}>
      ...
      <div className='flex-grow items-center border-2 md:shadow-sm rounded-full py-3'>
        <input 
          className='flex-grow pl-4 bg-transparent outline-none text-sm text-gray-600 placeholder-gray-400' 
